...
export function ChangeDisplayEmailForm(props) {
    ...
    return (
        ...
        <View style={styles.content}>
            ...
            />
            <Button title="Change email" containerStyle={styles.btnContainer} buttonStyle={styles.btn} onPress={formik.handleSubmit} loading={formik.isSubmitting} />
        </View>
